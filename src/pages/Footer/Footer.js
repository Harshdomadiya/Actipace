      ...
      <div className="container mx-auto px-16">
        <div className="flex flex-col lg:flex-row justify-between">
          ...
          <div className="mb-8 md:mb-0 text-center">
            ...
            <ul className=" font-Helvetic text-sm mb-4 flex flex-col gap-2">
              <li>
                <a target="_blank" href="https://actipace.com/terms">
                  Terms and conditions
                </a>
              </li>
              <li>
                <a target="_blank" href="https://actipace.com/privacy/">
                  Privacy Policy
                </a>
              </li>
              <li>
                <a target="_blank" href="https://actipace.com/refund/">
                  Cancellation and Refund
                </a>
              </li>
              <li>
                <a href="https://actipace.com/refund" target="_blank">
