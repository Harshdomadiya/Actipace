            ...
            <div className="lg:w-1/2 bg-white flex  items-center justify-center">
                <div className="w-[500px] lg:ml-[60px] mx-4">
                    ...
                    <form id="checkoutForm" onSubmit={handleSubmit} className="space-y-4 font-roboto text-[14px]">
                        ...
                        <div>
                            <label htmlFor="email" className="block text-[#111827] font-medium">Email address<span
                                className="text-red-500"> *</span></label>
                            <input
                                type="email"
                                className="w-full mt-1 p-4 border border-[#DBDDE3] placeholder-[#A6ADB3]  placeholder-roboto rounded-md"
                        ...
                        <div>
                            <label htmlFor="confirmEmail" className="block text-[#111827] font-medium">Confirm Email
                        ...
                        <div>
                            <label htmlFor="phoneNumber" className="block text-[#111827] font-medium">Phone Number<span
                                className="text-red-500"> *</span></label>
                            <input
                                type="tel"
                                className="w-full mt-1 p-4 border border-[#DBDDE3] placeholder-[#A6ADB3]  placeholder-roboto rounded-md"
                        ...
                        <div>
                            <label htmlFor="country" className="block text-[#111827] font-medium">Country<span
                                className="text-red-500"> *</span></label>
                            <input
                                type="text"
                                className="w-full mt-1 p-4 border border-[#DBDDE3] placeholder-[#A6ADB3]  placeholder-roboto rounded-md"
                        ...
                        <div>
                            <label htmlFor="gstin" className="block text-[#111827] font-medium">GSTIN</label>
                            <input
                                type="text"
                                className="w-full mt-1 p-4 border border-[#DBDDE3] placeholder-[#A6ADB3]  placeholder-roboto rounded-md"
                                id="gstin"
                    ...
                    <div className='h-[120px] flex justify-between '>
                        <div className='flex gap-5'>
                            ...
                            <div className='flex flex-col justify-between'>
                                ...
                                <div className='text-[20px] font-bold flex items-center'>{data.icon === 1 ?
                                    <IoLogoUsd className="h-[18px] w-[18px]"/> :
                                    <PiCurrencyInr className="h-[18px] w-[18px]"/>}{finalmaount}</div>
                            </div>
                        </div>
                        <button onClick={handleDelete} className='text-[#FF070C]  flex items-start'>Delete</button>
                    </div>
                    <div className='flex flex-col gap-3 mt-[10px]'>
                        <div className='flex justify-between text-[14px]'>
                            <div className='text-[#A6ADB3] '>Total Amount Before GST</div>
                            <div className='flex items-center gap-[2px]'>{data.icon === 1 ?
