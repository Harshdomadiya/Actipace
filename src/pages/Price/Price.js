        ...
        const amountfetch = async () => {
            try {
                ...
                if (curr === "USD") {
                    ...
                    //console.log(vl)
                    setamountA(Number(vl.toFixed(2)))
                } else {
        ...
        const amountfetch = async () => {
            try {
                ...
                if (curr === "USD") {
                    ...
                    const vl = amount.data.amount.price / val
                    //console.log(vl)
                    setamountB(Number(vl.toFixed(2)))
                } else {
        ...
        const amountfetch = async () => {
            try {
                ...
                if (curr === "USD") {
                    ...
                    const vl = amount.data.amount.price / val
                    //console.log(vl)
                    setamountC(Number(vl.toFixed(2)))
                } else {
        ...
        <div className="w-full relative flex-col">
            ...
            <div className="w-auto h-auto flex flex-col sm:flex-row md:flex-row lg:flex-row justify-center items-center gap-[40px] mt-[50px]">
                <div className="w-[320px] h-[790px] flex flex-col shadow-2xl">
                    ...
                    <div
                        className="h-10 text-[50px] mt-[20px] mb-[50px] justify-center flex text-[#31BF5C] font-inter font-bold">
                        {curr === "USD" ? <IoLogoUsd className="h-[30px] w-[30px] mt-[17px]"/> :
                    ...
                    <div className="flex justify-center items-center gap-10 mt-5">
                        <div className="flex flex-col justify-center items-center gap-2">
                            <div className="flex gap-3 justify-center items-center">
                                <button onClick={() => DeviceSetM(TotalD, SetTotalD)}
                                    ...
                                    <MdOutlineHorizontalRule className="w-[25px]"/></button>
                                <div
                                    className="w-[35px] h-[30px] bg-[#e4e5e5] text-[#424D56] flex justify-center items-center text-[20px] rounded-[4px] font-normal">{TotalD}</div>
                                <button onClick={() => DeviceSetP(TotalD, SetTotalD)}
                        ...
                        <div className="flex flex-col justify-center items-center gap-2">
                            <div className="flex gap-3 justify-center items-center">
                                <button onClick={() => YearSetM(TotalY, SetTotalY)}
                                        className="bg-[#9DA9B0] w-[25px] h-[25px] rounded-full text-white text-[30px] flex justify-center items-center font-[700px]">
                                    <MdOutlineHorizontalRule className="w-[25px]"/></button>
                                <div
                                    className="w-[35px] h-[30px] bg-[#e4e5e5] text-[#424D56] flex justify-center items-center text-[20px] rounded-[4px] font-normal">{TotalY}</div>
                                <button onClick={() => YearSetP(TotalY, SetTotalY)}
                                        className="bg-[#31BF5C] w-[25px] h-[25px] rounded-full text-white text-[17px] flex justify-center items-center font-[700px]">
                                    <FaPlus/></button>
                            </div>
                    ...
                    <div className="w-ful  flex justify-center items-center mt-[30px]">
                        <button className="w-[280px] h-[55px] bg-[#31BF5C] rounded-sm text-white"
                                onClick={() => handleBuyA()}>BUY NOW
                        </button>
                    </div>


                    <div className="text-[12px] flex flex-col ml-[20px] mt-[30px] gap-[5px] font-[200px]">
                        <p className="text-[#071D2B] text-[14px] font-normal flex items-center gap-2"><FaCheck
                            className="w-[12px] h-[12px] text-[#31BF5C]"/> Real Time Protection</p>
                        <p className="text-[#071D2B] text-[14px] font-normal flex items-center gap-2"><FaCheck
                            className="w-[12px] h-[12px] text-[#31BF5C]"/> Ransomware Protection</p>
                        <p className="text-[#071D2B] text-[14px] font-normal flex items-center gap-2"><FaCheck
                            className="w-[12px] h-[12px] text-[#31BF5C]"/> USB Protection</p>
                        <p className="text-[#071D2B] text-[14px] font-normal flex items-center gap-2"><FaCheck
                            className="w-[12px] h-[12px] text-[#31BF5C]"/> Temp Files Cleaner</p>
                        <p className="text-[#071D2B] text-[14px] font-normal flex items-center gap-2"><FaCheck
                            className="w-[12px] h-[12px] text-[#31BF5C]"/> Website Blocker</p>
                        <p className="text-[#071D2B] text-[14px] font-normal flex items-center gap-2"><FaCheck
                            className="w-[12px] h-[12px] text-[#31BF5C]"/> Webcam Protection</p>
                        <p className="text-[#071D2B] text-[14px] font-normal flex items-center gap-2"><FaCheck
                            className="w-[12px] h-[12px] text-[#31BF5C]"/> Advertise Blocker (Phishing and Malicious</p>
                        <p className="text-[#071D2B] text-[14px] font-normal ml-[20px]">Website Protection)</p>
                        <p className="text-[#071D2B] text-[14px] font-normal flex items-center gap-2"><FaCheck
                            className="w-[12px] h-[12px] text-[#31BF5C]"/> Privacy Cleaner</p>
                        <p className="text-[#071D2B] text-[14px] font-normal flex items-center gap-2"><FaCheck
                            className="w-[12px] h-[12px] text-[#31BF5C]"/> Wifi Scanner</p>
                        <p className="text-[#071D2B] text-[14px] font-normal flex items-center gap-2"><FaCheck
                            className="w-[12px] h-[12px] text-[#31BF5C]"/> Data Encryption</p>
                        <p className="text-[#071D2B] text-[14px] font-normal flex items-center gap-2"><FaCheck
                            className="w-[12px] h-[12px] text-[#31BF5C]"/> Data Recovery</p>
                        <p className="text-[#071D2B] text-[14px] font-normal flex items-center gap-2"><FaCheck
                            className="w-[12px] h-[12px] text-[#31BF5C]"/> Backup Manager</p>
                        <p className="text-[#071D2B] text-[14px] font-normal flex items-center gap-2"><FaCheck
                            className="w-[12px] h-[12px] text-[#31BF5C]"/> Game Booster</p>
                        <p className="text-[#071D2B] text-[14px] font-normal flex items-center gap-2"><FaCheck
                            className="w-[12px] h-[12px] text-[#31BF5C]"/> Registry Cleaner</p>
                        <p className="text-[#071D2B] text-[14px] font-normal flex items-center gap-2"><FaCheck
                            className="w-[12px] h-[12px] text-[#31BF5C]"/> Registry Optimizer</p>
                    </div>
                ...
                <div className="w-[320px] h-[790px] flex flex-col shadow-2xl">
                    ...
                    <div className="flex justify-center items-center gap-10 mt-5">
                        <div className="flex flex-col justify-center items-center gap-2">
                            <div className="flex gap-3 justify-center items-center">
                                <button onClick={() => DeviceSetM(InterD, SetInterD)}
                                        className="bg-[#9DA9B0] w-[25px] h-[25px] rounded-full text-white text-[30px] flex justify-center items-center font-[700px]">
                                    <MdOutlineHorizontalRule className="w-[25px]"/></button>
                                <div
                                    className="w-[35px] h-[30px] bg-[#e4e5e5] text-[#424D56] flex justify-center items-center text-[20px] rounded-[4px] font-normal">{InterD}</div>
                                <button onClick={() => DeviceSetP(InterD, SetInterD)}
                                        className="bg-[#31BF5C] w-[25px] h-[25px] rounded-full text-white text-[17px] flex justify-center items-center font-[700px]">
                                    <FaPlus/></button>
                            </div>
                            <div className="font-bold text-[14px] text-[#424D56]">DEVICES</div>
                        ...
                        <div className="flex flex-col justify-center items-center gap-2">
                            <div className="flex gap-3 justify-center items-center">
                                <button onClick={() => YearSetM(InterY, SetInterY)}
                                        className="bg-[#9DA9B0] w-[25px] h-[25px] rounded-full text-white text-[30px] flex justify-center items-center font-[700px]">
                                    <MdOutlineHorizontalRule className="w-[25px]"/></button>
                                <div
                                    className="w-[35px] h-[30px] bg-[#e4e5e5] text-[#424D56] flex justify-center items-center text-[20px] rounded-[4px] font-normal">{InterY}</div>
                                <button onClick={() => YearSetP(InterY, SetInterY)}
                                        className="bg-[#31BF5C] w-[25px] h-[25px] rounded-full text-white text-[17px] flex justify-center items-center font-[700px]">
                                    <FaPlus/></button>
                            </div>
                            <div className="font-bold text-[14px] text-[#424D56]">YEAR</div>
                    ...
                    <div className="text-[12px] flex flex-col ml-[20px] mt-[30px] gap-[5px] font-[200px]">
                        ...
                        <p className="text-[#071D2B] text-[14px] font-normal flex items-center gap-2"><FaCheck
                            className="w-[12px] h-[12px] text-[#31BF5C]"/> Wifi Scanner</p>
                        <p className="text-[#9DA9B0] text-[14px] font-normal flex items-center gap-3"><ImCross
                            className="w-[8px] h-[8px]"/> Data Encryption</p>
                        <p className="text-[#9DA9B0] text-[14px] font-normal flex items-center gap-3"><ImCross
                            className="w-[8px] h-[8px]"/> Data Recovery</p>
                        <p className="text-[#9DA9B0] text-[14px] font-normal flex items-center gap-3"><ImCross
                            className="w-[8px] h-[8px]"/> Backup Manager</p>
                        <p className="text-[#9DA9B0] text-[14px] font-normal flex items-center gap-3"><ImCross
                            className="w-[8px] h-[8px]"/> Game Booster</p>
                        <p className="text-[#9DA9B0] text-[14px] font-normal flex items-center gap-3"><ImCross
                            className="w-[8px] h-[8px]"/> Registry Cleaner</p>
                        <p className="text-[#9DA9B0] text-[14px] font-normal flex items-center gap-3"><ImCross
                            className="w-[8px] h-[8px]"/> Registry Optimizer</p>
                    </div>
                ...
                <div className="w-[320px] h-[790px] flex flex-col shadow-2xl">
                    ...
                    <div className="flex justify-center items-center gap-10 mt-5">
                        <div className="flex flex-col justify-center items-center gap-2">
                            <div className="flex gap-3 justify-center items-center">
                                <button onClick={() => DeviceSetM(LiteD, SetLiteD)}
                                        className="bg-[#9DA9B0] w-[25px] h-[25px] rounded-full text-white text-[30px] flex justify-center items-center font-[700px]">
                                    <MdOutlineHorizontalRule className="w-[25px]"/></button>
                                <div
                                    className="w-[35px] h-[30px] bg-[#e4e5e5] text-[#424D56] flex justify-center items-center text-[20px] rounded-[4px] font-normal">{LiteD}</div>
                                <button onClick={() => DeviceSetP(LiteD, SetLiteD)}
                                        className="bg-[#31BF5C] w-[25px] h-[25px] rounded-full text-white text-[17px] flex justify-center items-center font-[700px]">
                                    <FaPlus/></button>
                            </div>
                            <div className="font-bold text-[14px] text-[#424D56]">DEVICES</div>
                        ...
                        <div className="flex flex-col justify-center items-center gap-2">
                            <div className="flex gap-3 justify-center items-center">
                                <button onClick={() => YearSetM(LiteY, SetLiteY)}
                                        className="bg-[#9DA9B0] w-[25px] h-[25px] rounded-full text-white text-[30px] flex justify-center items-center font-[700px]">
                                    <MdOutlineHorizontalRule className="w-[25px]"/></button>
                                <div
                                    className="w-[35px] h-[30px] bg-[#e4e5e5] text-[#424D56] flex justify-center items-center text-[20px] rounded-[4px] font-normal">{LiteY}</div>
                                <button onClick={() => YearSetP(LiteY, SetLiteY)}
                                        className="bg-[#31BF5C] w-[25px] h-[25px] rounded-full text-white text-[17px] flex justify-center items-center font-[700px]">
                                    <FaPlus/></button>
                            </div>
                            <div className="font-bold text-[14px] text-[#424D56]">YEAR</div>
                    ...
                    <div className="text-[12px] flex flex-col ml-[20px] mt-[30px] gap-[5px] font-[200px]">
                        ...
                        <p className="text-[#071D2B] text-[14px] font-normal flex items-center gap-2"><FaCheck
                            className="w-[12px] h-[12px] text-[#31BF5C]"/> Temp Files Cleaner</p>
                        <p className="text-[#9DA9B0] text-[14px] font-normal flex items-center gap-3"><ImCross
                            className="w-[8px] h-[8px]"/> Website Blocker</p>
                        <p className="text-[#9DA9B0] text-[14px] font-normal flex items-center gap-3"><ImCross
                            className="w-[8px] h-[8px]"/> Webcam Protection</p>
                        <p className="text-[#9DA9B0] text-[14px] font-normal flex items-center gap-3"><ImCross
                            className="w-[8px] h-[8px]"/> Advertise Blocker (Phishing and Malicious</p>
                        <p className="ml-[20px] text-[#9DA9B0] text-[14px] font-normal">Website Protection)</p>
                        <p className="text-[#9DA9B0] text-[14px] font-normal flex items-center gap-3"><ImCross
                            className="w-[8px] h-[8px]"/> Privacy Cleaner</p>
                        <p className="text-[#9DA9B0] text-[14px] font-normal flex items-center gap-3"><ImCross
                            className="w-[8px] h-[8px]"/> Wifi Scanner</p>
                        <p className="text-[#9DA9B0] text-[14px] font-normal flex items-center gap-3"><ImCross
                            className="w-[8px] h-[8px]"/> Data Encryption</p>
                        <p className="text-[#9DA9B0] text-[14px] font-normal flex items-center gap-3"><ImCross
                            className="w-[8px] h-[8px]"/> Data Recovery</p>
            ...
            <div className="w-full flex mt-10 flex-col items-center gap-8 mb-20">
                ...
                <div
                    className="w-full flex flex-col justify-center items-center text-[#374151] font-normal text-[16px]">
